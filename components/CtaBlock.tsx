        ...
        <ScrollReveal variant="scale-up" duration={800}>
          <div className="rounded-4xl bg-lime p-8 text-ink md:p-14">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <a
                href="#capabilities"
                className="inline-flex items-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-medium text-ink transition hover:bg-white/90 hover:shadow-lg"
              >
                Explore Capabilities
              </a>
              <a
                href="#contact"
                className="group inline-flex items-center gap-2 rounded-full bg-ink py-2 pl-5 pr-2 text-sm font-medium text-white transition hover:opacity-90 hover:shadow-lg"
              >
                Talk to Us
